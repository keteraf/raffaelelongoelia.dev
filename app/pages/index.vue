...
// ─── SEO ────────────────────────────────────────────────────────────────────
useSeoMeta({
  title: 'Raffaele Longo Elia — Full-Stack Developer',
  ...
  ogTitle: 'Raffaele Longo Elia — Full-Stack Developer',
  ogDescription: 'Personal portfolio of Raffaele Longo Elia — full-stack developer. Explore projects, skills, and contact info through an interactive terminal.',
  twitterTitle: 'Raffaele Longo Elia — Full-Stack Developer',
  twitterDescription: 'Personal portfolio of Raffaele Longo Elia — full-stack developer. Explore projects, skills, and contact info through an interactive terminal.',
  twitterCard: 'summary_large_image',
})

defineOgImage('Default', {
  title: 'Raffaele Longo Elia',
...
useSchemaOrg([
  definePerson({
    ...
    sameAs: ['https://github.com/keteraf'],
  }),
  defineWebSite({
    name: 'Raffaele Longo Elia',
    description: 'Personal portfolio of Raffaele Longo Elia — full-stack developer.',
  }),
  defineWebPage({
    name: 'Raffaele Longo Elia — Full-Stack Developer',
  }),
])
// ────────────────────────────────────────────────────────────────────────────
